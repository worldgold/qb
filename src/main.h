...
static const int64 MAX_MONEY = 2000000000 * COIN; // EB3Coin: maximum of N coins (given some randomness), max transaction 10,000,000,000 for now
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > 2 * COIN * (60 * 24 / 4.33) / 250; // EB3Coin: Priority cutoff is 2 EB3Coin day / 250 bytes.
    }
