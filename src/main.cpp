...
uint256 hashGenesisBlock("0xdd3e201c97dc0721403f313cd95cd00866179d35fd53de2fb68ef2c806601a95");
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "the eb3 genesis block";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
	    ...
	    assert(block.hashMerkleRoot == uint256("0x181e48aed42b38a439202d037fa9c2aa7f5734b2b797868daf6a3fdaf21b172e"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xa0, 0xc5, 0xb6, 0xfb };
